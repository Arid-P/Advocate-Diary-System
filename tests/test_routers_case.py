...
def test_create_case(client: TestClient):
    ...
    client_resp = client.post(
        "/clients/", json={"name": "Client A", "address": "Address A"}
    )
...
def test_get_cases_by_client(client: TestClient):
    client_resp = client.post(
        "/clients/", json={"name": "Client B", "address": "Address B"}
    )
    client_id = client_resp.json()["id"]
...
def test_get_all_cases(client: TestClient):
    client_resp = client.post(
        "/clients/", json={"name": "Client C", "address": "Address C"}
    )
    client_id = client_resp.json()["id"]
    client.post(
        "/cases/",
...
def test_update_case(client: TestClient):
    client_resp = client.post(
        "/clients/", json={"name": "Client D", "address": "Address D"}
    )
    client_id = client_resp.json()["id"]
    case_resp = client.post(
        "/cases/",
...
def test_delete_case(client: TestClient):
    client_resp = client.post(
        "/clients/", json={"name": "Client E", "address": "Address E"}
    )
    client_id = client_resp.json()["id"]
    case_resp = client.post(
        "/cases/",
